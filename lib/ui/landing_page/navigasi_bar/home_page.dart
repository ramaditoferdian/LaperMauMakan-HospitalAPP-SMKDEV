...
class _HomePageState extends State<HomePage> {
  ...
  void initState() {
    ...
    Timer.periodic(Duration(seconds: 5), (timer) {
      ...
      if (page >= _deskripsiAwal.length - 1) {
  ...
  // String namaDokter, kategoriDokter;
                ...
                return Container(
                  ...
                  child: ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        return DoctorCard(
                          namaDokter:
                              snapshot.data.docs.elementAt(index)['dokterName'],
                          kategoriDokter: snapshot.data.docs
                              .elementAt(index)['dokterKategori'],
                          urlPict:
                              snapshot.data.docs.elementAt(index)['urlPicture'],
                        );
                      }),
                );
              })
...
class DoctorCard extends StatelessWidget {
  ...
  final String kategoriDokter;
  final String urlPict;

  DoctorCard({this.namaDokter, this.kategoriDokter, this.urlPict});

  @override
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () {
        // PINDAH KE HALAMAN DETAIL DOKTER YANG DITUJU
      },
      child: Container(
        width: 150.0,
